...
<div id="header-post" class="header-post">
    <div class="container">
        <div class="row">
       <div class="col-md-12">
            <h2 class="text-dark mt-4">Update Post</h2>
       </div>
       <div class="col-md-offset-3 col-md-6">
       <form action="" method="POST" class="bg-light p-4 mt-3">
       <div class="form-group">
       <label for="post-title">Tittle</label>
           <input type="text" class="form-control" value="lorem is word most use in web" id="post-tile" name="post-tile" required>
       </div>
       <div class="form-group">
           <label for="post-desciption">Description</label>
          <textarea class="form-control" id="post-des" name="post-des" >
       ...
       <input type="file" name="new-image" id="new-image" class="mb-2">
        <img  src="upload/bangladesh.jpg" height="150px">
