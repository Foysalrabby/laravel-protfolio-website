...
<body>
   ...
   <div id="header-post" class="header-post">
    <div class="container">
        <div class="row">
       <div class="col-md-6">
            <h2 class="text-dark mt-4 ml-3">ALL POST</h2>
       </div>
       <div class="col-md-6">
            <a href="add-post.php" class="btn btn-new1 btn-light mr-3">ADD POST</a>
       </div>
        </div>
        <div class="col-md-12">
            ...
            <tbody>
                <tr>
                   ...
                   <td>01 Nov 2021</td> 
                   <td>Admin</td> 
                   <td><a href="update-post.php"><i class="fa fa-edit"></i></a></td> 
