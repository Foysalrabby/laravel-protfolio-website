      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-offset-3 col-md-6">
                  <!-- Form Start -->
                  <form action="" method="POST" autocomplete="off" class=" bg-light p-5 mt-4 mb-4">
                      <div class="form-group">
                          <label>Category Name</label>
                          <input type="text" name="catname" value="html" class="form-control" placeholder="Category Name" required>
                      </div>
